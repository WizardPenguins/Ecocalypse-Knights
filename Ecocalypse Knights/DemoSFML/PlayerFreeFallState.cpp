...
void PlayerFreeFallState::UpdateAnim(float _dt)
{
	...
	if (player->freefallAnimeLeftToRight)
	{
		...
		if (player->currentAnime.currentFrame == 13)
		{
			sf::IntRect rect = sf::IntRect((player->currentAnime.currentFrame -1) * player->currentAnime.frameSize.x, 0 * player->currentAnime.frameSize.y + 1, player->currentAnime.frameSize.x, player->currentAnime.frameSize.y);
	...
	else if (!player->freefallAnimeLeftToRight)
	{
		...
		if (player->currentAnime.currentFrame == 7)
		{
			sf::IntRect rect = sf::IntRect((player->currentAnime.frameSize.x * player->currentAnime.maxFrame) - ((player->currentAnime.currentFrame-1) * player->currentAnime.frameSize.x), 0 * player->currentAnime.frameSize.y + 1, player->currentAnime.frameSize.x, player->currentAnime.frameSize.y);
			player->sprite.setTextureRect(rect);
		}
	}
}
