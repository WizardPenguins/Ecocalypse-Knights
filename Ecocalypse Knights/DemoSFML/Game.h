...
private:
	...
	void DisplayHand(std::vector<Mob*>& _mob, sf::RenderWindow& _window, GameData& _gameData);
	void DisplayHand(std::vector<Mob*>& _mob, sf::RenderTexture& _red, sf::RenderTexture& _blue, GameData& _gameData);
