...
void HUD::Display(sf::RenderTexture& _red, sf::RenderTexture& _blue,std::vector<Player*>& _tabPlayer,bool _arena)
{
	for (int i = 0; i < spriteIconsPlayers.size(); i++)
	{
		Utils::BlitSprite(spriteIconsPlayers[i], sf::Vector2f{ spriteIconsPlayers[i].getPosition().x + (TROAD_GAP * (-1 * 650.f + WORKING_HEIGHT) / 100.f),spriteIconsPlayers[i].getPosition().y }, _red, 0);
		Utils::BlitSprite(spriteIconsPlayers[i], sf::Vector2f{ spriteIconsPlayers[i].getPosition().x - (TROAD_GAP * (-1 * 650.f + WORKING_HEIGHT) / 100.f),spriteIconsPlayers[i].getPosition().y }, _blue, 0);

		Utils::BlitSprite(spriteFramePlayers[i], sf::Vector2f{ spriteFramePlayers[i].getPosition().x + (TROAD_GAP * (-1 * 650.f + WORKING_HEIGHT) / 100.f),spriteFramePlayers[i].getPosition().y }, _red, 0);
		Utils::BlitSprite(spriteFramePlayers[i], sf::Vector2f{ spriteFramePlayers[i].getPosition().x - (TROAD_GAP * (-1 * 650.f + WORKING_HEIGHT) / 100.f),spriteFramePlayers[i].getPosition().y }, _blue, 0);

		for (int j = 0; j < spriteHealthPlayers[i].size(); j++)
		{
			Utils::BlitSprite(spriteHealthPlayers[i][j], sf::Vector2f{ spriteHealthPlayers[i][j].getPosition().x + (TROAD_GAP * (-1 * 650.f + WORKING_HEIGHT)/ 100.f),spriteHealthPlayers[i][j].getPosition().y }, _red, 0);
			Utils::BlitSprite(spriteHealthPlayers[i][j], sf::Vector2f{ spriteHealthPlayers[i][j].getPosition().x - (TROAD_GAP * (-1 * 650.f + WORKING_HEIGHT)/ 100.f),spriteHealthPlayers[i][j].getPosition().y }, _blue, 0);
		}

		for (int j = 0; j < _tabPlayer[i]->GetMaxMana(); j++)
		{
			Utils::BlitSprite(spriteManaPlayers[i][j], sf::Vector2f{ spriteManaPlayers[i][j].getPosition().x + (TROAD_GAP * (-1 *  650.f + WORKING_HEIGHT)/ 100.f),spriteManaPlayers[i][j].getPosition().y }, _red, 0);
			Utils::BlitSprite(spriteManaPlayers[i][j], sf::Vector2f{ spriteManaPlayers[i][j].getPosition().x - (TROAD_GAP * (-1 *  650.f + WORKING_HEIGHT)/ 100.f),spriteManaPlayers[i][j].getPosition().y }, _blue, 0);
		}

		//display mana recovery if player is not full mana
		if (playAnimManaRecovery[i])
		{
			Utils::BlitSprite(spritePlayersManaRecovery[i], sf::Vector2f{ spritePlayersManaRecovery[i].getPosition().x + (TROAD_GAP * (-1 * 650.f + WORKING_HEIGHT)/ 100.f),spritePlayersManaRecovery[i].getPosition().y }, _red, 0);
			Utils::BlitSprite(spritePlayersManaRecovery[i], sf::Vector2f{ spritePlayersManaRecovery[i].getPosition().x - (TROAD_GAP * (-1 * 650.f + WORKING_HEIGHT)/ 100.f),spritePlayersManaRecovery[i].getPosition().y }, _blue, 0);
		}

		if (!_arena)
		{
			Utils::BlitSprite(spriteXpBarBackgroundPlayers[i], sf::Vector2f{ spriteXpBarBackgroundPlayers[i].getPosition().x + (TROAD_GAP * (-1 * 650.f + WORKING_HEIGHT) / 100.f),spriteXpBarBackgroundPlayers[i].getPosition().y }, _red, 0);
			Utils::BlitSprite(spriteXpBarBackgroundPlayers[i], sf::Vector2f{ spriteXpBarBackgroundPlayers[i].getPosition().x - (TROAD_GAP * (-1 * 650.f + WORKING_HEIGHT) / 100.f),spriteXpBarBackgroundPlayers[i].getPosition().y }, _blue, 0);

			int xpBarSize = _tabPlayer[i]->GetXp() * 100 / _tabPlayer[i]->GetMaxXp();
			for (int j = 0; j < xpBarSize; j++)
			{
				Utils::BlitSprite(spriteXpBarPlayers[i][j], sf::Vector2f{ spriteXpBarPlayers[i][j].getPosition().x + (TROAD_GAP * (-1 * 650.f + WORKING_HEIGHT) / 100.f),spriteXpBarPlayers[i][j].getPosition().y }, _red, 0);
				Utils::BlitSprite(spriteXpBarPlayers[i][j], sf::Vector2f{ spriteXpBarPlayers[i][j].getPosition().x - (TROAD_GAP * (-1 * 650.f + WORKING_HEIGHT) / 100.f),spriteXpBarPlayers[i][j].getPosition().y }, _blue, 0);
			}
			Utils::BlitSprite(spriteXpBarOverPlayers[i], sf::Vector2f{ spriteXpBarOverPlayers[i].getPosition().x + (TROAD_GAP * (-1 * 650.f + WORKING_HEIGHT) / 100.f),spriteXpBarOverPlayers[i].getPosition().y }, _red, 0);
			Utils::BlitSprite(spriteXpBarOverPlayers[i], sf::Vector2f{ spriteXpBarOverPlayers[i].getPosition().x - (TROAD_GAP * (-1 * 650.f + WORKING_HEIGHT) / 100.f),spriteXpBarOverPlayers[i].getPosition().y }, _blue, 0);
			
			sf::Vector2f posText = lvlText[i].getPosition();
			
			lvlText[i].setPosition(posText.x + (TROAD_GAP * (-1 * 650.f + WORKING_HEIGHT) / 100.f), posText.y);
			_red.draw(lvlText[i]);
			...
			Utils::BlitSprite(spritePlayersInventory[i], sf::Vector2f{ spritePlayersInventory[i].getPosition().x + (TROAD_GAP * (-1 * 650.f + WORKING_HEIGHT) / 100.f),spritePlayersInventory[i].getPosition().y }, _red, 0);
			Utils::BlitSprite(spritePlayersInventory[i], sf::Vector2f{ spritePlayersInventory[i].getPosition().x - (TROAD_GAP * (-1 * 650.f + WORKING_HEIGHT) / 100.f),spritePlayersInventory[i].getPosition().y }, _blue, 0);
		}
	}
}
...
void HUD::DisplayMigrant3D(GameData& _gameData)
{
	...
	for (int i = 0; i < spritePlayersCanBeRevived.size(); i++)
	{
		...
		{
			nbPlayersDead++;
			Utils::BlitSprite(spritePlayersCanBeRevived[i], sf::Vector2f{ spritePlayersCanBeRevived[i].getPosition().x + (TROAD_GAP * (-1 * 800.f + WORKING_HEIGHT) / 100.f),spritePlayersCanBeRevived[i].getPosition().y }, _gameData.renderTextureRed);
			Utils::BlitSprite(spritePlayersCanBeRevived[i], sf::Vector2f{ spritePlayersCanBeRevived[i].getPosition().x - (TROAD_GAP * (-1 * 800.f + WORKING_HEIGHT) / 100.f),spritePlayersCanBeRevived[i].getPosition().y }, _gameData.renderTextureBlue);
		}
	}
}
