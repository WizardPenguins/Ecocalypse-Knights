...
public:
	...
	int displayMode = sf::Style::Fullscreen;
	...
	bool reloadMapManager = false;
	bool reloadFlyingNut = false;
	bool reloadLevelManager = false;
	...
	bool birdSpawn = false;
	bool witchSpawn = false;
	bool bridgeStartBroken = false;

	sf::RenderTexture* rt;
	sf::RenderTexture* rtSrinks;
	sf::RenderTexture* rtRed;
	sf::RenderTexture* rtBlue;
	sf::Sprite rtShadow;
	sf::Sprite rtShadowSrinks;
	...
	std::vector<PopUp*> popUpTutoVector;
	std::vector<PopUp*> popUpPotionVector;
	std::vector<PopUp*> popUpAOEVector;
	int currentPopUpTuTo = 0;
	int currentPopUpPotion = 0;
	int currentPopUpAOE = 0;
	sf::Image tempImage1;
	sf::Image tempImage2;
	sf::Image tempImage3;
	sf::Font* GameFont;
	...
	sfe::Movie witchDeath;
	bool playWitchDeath = false;
};
