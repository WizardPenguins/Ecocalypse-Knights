...
public:
	...
	void LoopVideo(GameData& _gameData);
	...
	void DisplayFirstPlanLevel3(sf::RenderTexture& _red, sf::RenderTexture& _blue,bool);
...
private:
	...
	sf::Sprite backGroundLevel3Boss[5];
	...
	sf::Sprite crack[2];
	Animation* crackAnimation[2];
	float timerBridge = 0;

	sf::Vector2f startPosEasings;
	sf::Vector2f endPosEasings;

	sf::Sprite fallingBackGround;
	Animation* fallingBackGroundAnimation;

	sf::Sprite mask;
	sf::Sprite mask2;

	float timerMask = 0.f;
	float timerMask2 = 0.f;
	sf::Vector2f startPosMask;
	sf::Vector2f endPosMask;	
	sf::Vector2f startPosMask2;
	sf::Vector2f endPosMask2;
};
