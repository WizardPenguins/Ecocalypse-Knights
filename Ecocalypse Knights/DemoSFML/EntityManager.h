...
public:
	...
	void UpdateWitchHitBox(Witch* _witch, std::vector<Player*>& _player, std::vector<Projectile>& _projectile, Audio& _audio);
	...
	void SetFreeFall(std::vector<Player*>& _player);
	bool waveLaunch = false;

	//surdef
	void MobArrowCollision(std::vector<Projectile>& _projectile, std::vector<Scarecrow*>& _scarecrow, std::vector<Player*>& _player, Audio& _audio);
...
private :
	...
	void FillVectorSort(GameData& _gameData,std::vector<Projectile>& _projectile, std::vector<Player*>& _player, std::vector<Mob*>& _mob, std::vector<Building*>& _building, std::vector<Drop*>& _food, std::vector<Sort*>& _sort, std::vector<Scarecrow*>& _scarecrow, std::vector<Building*>& _sleepingNut);
