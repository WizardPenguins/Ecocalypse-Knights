...
public:
    ...
    enum Axis
    {
        LEFT_JOYSTICK_X,  ///< The X axis
        LEFT_JOYSTICK_Y,  ///< The Y axis
        TRIGGERS_L2_R2,
        RIGHT_JOYSTICK_X,   ///< The Z axis
        RIGHT_JOYSTICK_Y,          ///< The R axis
         ///< The U axis
        USELESS, ///< The V axis
        DIR_CROSS_X,      ///< The X axis of the directional cross
        DIR_CROSS_Y,      ///< The Y axis of the directional cross
    };
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Check if a joystick Axis is pressed (for a trigger for example)
    ///
    /// If the joystick is not connected, this function returns false.
    ///
    /// \param joystick Index of the joystick
    /// \param button   Axis to check
    ///
    /// \return True if the button is pressed, false otherwise
    ///
    ////////////////////////////////////////////////////////////
    static bool isAxisPressed(unsigned int joystick, Axis axis, unsigned int _operator);
...
/// bool hasX = sf::Joystick::hasAxis(0, sf::Joystick::LEFT_JOYSTICK_X);
///
/// // Is button #2 pressed on joystick #0?
/// bool pressed = sf::Joystick::isButtonPressed(0, 2);
///
/// // What's the current position of the Y axis on joystick #0?
/// float position = sf::Joystick::getAxisPosition(0, sf::Joystick::LEFT_JOYSTICK_Y);
/// \endcode
///
