...
void Settings::InitSprites(void)
{
	...
	buttonVect.push_back(new Button("Assets/Images/Hud/BackButton.png", { tPos.x, tPos.y + tSize.y / 2 }, 3, Screen::Scale(1, 1), false));
...
void Settings::Display3D(GameData& _gameData)
{
	...
	Utils::BlitSprite(backgroundSprite, sf::Vector2f{ backgroundSprite.getPosition().x - (TROAD_GAP * (-1 * backgroundSprite.getPosition().y + WORKING_HEIGHT) / 100.f),backgroundSprite.getPosition().y }, 0, _gameData.renderTextureRed);
	Utils::BlitSprite(backgroundSprite, sf::Vector2f{ backgroundSprite.getPosition().x + (TROAD_GAP * (-1 * backgroundSprite.getPosition().y + WORKING_HEIGHT) / 100.f),backgroundSprite.getPosition().y }, 0, _gameData.renderTextureBlue);

	Utils::BlitSprite(_gameData.flame, sf::Vector2f{ _gameData.flame.getPosition().x - (TROAD_GAP * (-1 * _gameData.flame.getPosition().y + WORKING_HEIGHT) / 100.f),_gameData.flame.getPosition().y }, 0, _gameData.renderTextureRed);
	Utils::BlitSprite(_gameData.flame, sf::Vector2f{ _gameData.flame.getPosition().x + (TROAD_GAP * (-1 * _gameData.flame.getPosition().y + WORKING_HEIGHT) / 100.f),_gameData.flame.getPosition().y }, 0, _gameData.renderTextureBlue);

	Utils::BlitSprite(transparentSprite, sf::Vector2f{ transparentSprite.getPosition().x - (TROAD_GAP * (-1 * transparentSprite.getPosition().y + WORKING_HEIGHT) / 100.f),transparentSprite.getPosition().y }, 0, _gameData.renderTextureRed);
	Utils::BlitSprite(transparentSprite, sf::Vector2f{ transparentSprite.getPosition().x + (TROAD_GAP * (-1 * transparentSprite.getPosition().y + WORKING_HEIGHT) / 100.f),transparentSprite.getPosition().y }, 0, _gameData.renderTextureBlue);

	Utils::BlitSprite(volumeBar, sf::Vector2f{ volumeBar.getPosition().x + (TROAD_GAP * (-1 * volumeBar.getPosition().y + WORKING_HEIGHT) / 100.f),volumeBar.getPosition().y }, 0, _gameData.renderTextureRed);
	Utils::BlitSprite(volumeBar, sf::Vector2f{ volumeBar.getPosition().x - (TROAD_GAP * (-1 * volumeBar.getPosition().y + WORKING_HEIGHT) / 100.f),volumeBar.getPosition().y }, 0, _gameData.renderTextureBlue);

	Utils::BlitSprite(volumeRect, sf::Vector2f{ volumeRect.getPosition().x + (TROAD_GAP * (-1 * volumeRect.getPosition().y + WORKING_HEIGHT) / 100.f),volumeRect.getPosition().y }, 0, _gameData.renderTextureRed);
	Utils::BlitSprite(volumeRect, sf::Vector2f{ volumeRect.getPosition().x - (TROAD_GAP * (-1 * volumeRect.getPosition().y + WORKING_HEIGHT) / 100.f),volumeRect.getPosition().y }, 0, _gameData.renderTextureBlue);

	Utils::BlitSprite(volumeBarName, sf::Vector2f{ volumeBarName.getPosition().x + (TROAD_GAP * (-1 * volumeBarName.getPosition().y + WORKING_HEIGHT) / 100.f),volumeBarName.getPosition().y }, 0, _gameData.renderTextureRed);
	Utils::BlitSprite(volumeBarName, sf::Vector2f{ volumeBarName.getPosition().x - (TROAD_GAP * (-1 * volumeBarName.getPosition().y + WORKING_HEIGHT) / 100.f),volumeBarName.getPosition().y }, 0, _gameData.renderTextureBlue);

	sf::Vector2f posTexte = volumeText.getPosition();

	volumeText.setPosition(sf::Vector2f{ posTexte.x + (TROAD_GAP * (-1 * posTexte.y + WORKING_HEIGHT) / 100.f),posTexte.y });
	...
	Utils::BlitSprite(displayType, sf::Vector2f{ displayType.getPosition().x + (TROAD_GAP * (-1 * displayType.getPosition().y + WORKING_HEIGHT) / 100.f),displayType.getPosition().y }, 0, _gameData.renderTextureRed);
	Utils::BlitSprite(displayType, sf::Vector2f{ displayType.getPosition().x - (TROAD_GAP * (-1 * displayType.getPosition().y + WORKING_HEIGHT) / 100.f),displayType.getPosition().y }, 0, _gameData.renderTextureBlue);

	Utils::BlitSprite(displayModeName, sf::Vector2f{ displayModeName.getPosition().x + (TROAD_GAP * (-1 * displayModeName.getPosition().y + WORKING_HEIGHT) / 100.f),displayModeName.getPosition().y }, 0, _gameData.renderTextureRed);
	Utils::BlitSprite(displayModeName, sf::Vector2f{ displayModeName.getPosition().x - (TROAD_GAP * (-1 * displayModeName.getPosition().y + WORKING_HEIGHT) / 100.f),displayModeName.getPosition().y }, 0, _gameData.renderTextureBlue);

	Utils::BlitSprite(hpBarMode, sf::Vector2f{ hpBarMode.getPosition().x + (TROAD_GAP * (-1 * hpBarMode.getPosition().y + WORKING_HEIGHT) / 100.f),hpBarMode.getPosition().y }, 0, _gameData.renderTextureRed);
	Utils::BlitSprite(hpBarMode, sf::Vector2f{ hpBarMode.getPosition().x - (TROAD_GAP * (-1 * hpBarMode.getPosition().y + WORKING_HEIGHT) / 100.f),hpBarMode.getPosition().y }, 0, _gameData.renderTextureBlue);

	Utils::BlitSprite(hpBarName, sf::Vector2f{ hpBarName.getPosition().x + (TROAD_GAP * (-1 * hpBarName.getPosition().y + WORKING_HEIGHT) / 100.f),hpBarName.getPosition().y }, 0, _gameData.renderTextureRed);
	Utils::BlitSprite(hpBarName, sf::Vector2f{ hpBarName.getPosition().x - (TROAD_GAP * (-1 * hpBarName.getPosition().y + WORKING_HEIGHT) / 100.f),hpBarName.getPosition().y }, 0, _gameData.renderTextureBlue);

	Utils::BlitSprite(friendShipMode, sf::Vector2f{ friendShipMode.getPosition().x + (TROAD_GAP * (-1 * friendShipMode.getPosition().y + WORKING_HEIGHT) / 100.f),friendShipMode.getPosition().y }, 0, _gameData.renderTextureRed);
	Utils::BlitSprite(friendShipMode, sf::Vector2f{ friendShipMode.getPosition().x - (TROAD_GAP * (-1 * friendShipMode.getPosition().y + WORKING_HEIGHT) / 100.f),friendShipMode.getPosition().y }, 0, _gameData.renderTextureBlue);

	Utils::BlitSprite(friendShipName, sf::Vector2f{ friendShipName.getPosition().x + (TROAD_GAP * (-1 * friendShipName.getPosition().y + WORKING_HEIGHT) / 100.f),friendShipName.getPosition().y }, 0, _gameData.renderTextureRed);
	Utils::BlitSprite(friendShipName, sf::Vector2f{ friendShipName.getPosition().x - (TROAD_GAP * (-1 * friendShipName.getPosition().y + WORKING_HEIGHT) / 100.f),friendShipName.getPosition().y }, 0, _gameData.renderTextureBlue);

	Utils::BlitSprite(thirdDimentionMode, sf::Vector2f{ thirdDimentionMode.getPosition().x + (TROAD_GAP * (-1 * thirdDimentionMode.getPosition().y + WORKING_HEIGHT) / 100.f),thirdDimentionMode.getPosition().y }, 0, _gameData.renderTextureRed);
	Utils::BlitSprite(thirdDimentionMode, sf::Vector2f{ thirdDimentionMode.getPosition().x - (TROAD_GAP * (-1 * thirdDimentionMode.getPosition().y + WORKING_HEIGHT) / 100.f),thirdDimentionMode.getPosition().y }, 0, _gameData.renderTextureBlue);

	Utils::BlitSprite(thirdDimentionName, sf::Vector2f{ thirdDimentionName.getPosition().x + (TROAD_GAP * (-1 * thirdDimentionName.getPosition().y + WORKING_HEIGHT) / 100.f),thirdDimentionName.getPosition().y }, 0, _gameData.renderTextureRed);
	Utils::BlitSprite(thirdDimentionName, sf::Vector2f{ thirdDimentionName.getPosition().x - (TROAD_GAP * (-1 * thirdDimentionName.getPosition().y + WORKING_HEIGHT) / 100.f),thirdDimentionName.getPosition().y }, 0, _gameData.renderTextureBlue);

	Utils::BlitSprite(tutoMode, sf::Vector2f{ tutoMode.getPosition().x + (TROAD_GAP * (-1 * tutoMode.getPosition().y + WORKING_HEIGHT) / 100.f),tutoMode.getPosition().y }, 0, _gameData.renderTextureRed);
	Utils::BlitSprite(tutoMode, sf::Vector2f{ tutoMode.getPosition().x - (TROAD_GAP * (-1 * tutoMode.getPosition().y + WORKING_HEIGHT) / 100.f),tutoMode.getPosition().y }, 0, _gameData.renderTextureBlue);

	Utils::BlitSprite(tutoName, sf::Vector2f{ tutoName.getPosition().x + (TROAD_GAP * (-1 * tutoName.getPosition().y + WORKING_HEIGHT) / 100.f),tutoName.getPosition().y }, 0, _gameData.renderTextureRed);
	Utils::BlitSprite(tutoName, sf::Vector2f{ tutoName.getPosition().x - (TROAD_GAP * (-1 * tutoName.getPosition().y + WORKING_HEIGHT) / 100.f),tutoName.getPosition().y }, 0, _gameData.renderTextureBlue);

	if (typeSelected[(int)TypeSelected::HP_BAR])
	{
		Utils::BlitSprite(hpBarPicture, sf::Vector2f{ hpBarPicture.getPosition().x + (TROAD_GAP * (-1 * hpBarPicture.getPosition().y + WORKING_HEIGHT) / 100.f),hpBarPicture.getPosition().y }, 0, _gameData.renderTextureRed);
		Utils::BlitSprite(hpBarPicture, sf::Vector2f{ hpBarPicture.getPosition().x - (TROAD_GAP * (-1 * hpBarPicture.getPosition().y + WORKING_HEIGHT) / 100.f),hpBarPicture.getPosition().y }, 0, _gameData.renderTextureBlue);
	}
	else if (typeSelected[(int)TypeSelected::FRIENDLY_FIRE])
	{
		Utils::BlitSprite(friendshipPicture, sf::Vector2f{ friendshipPicture.getPosition().x + (TROAD_GAP * (-1 * friendshipPicture.getPosition().y + WORKING_HEIGHT) / 100.f),friendshipPicture.getPosition().y }, 0, _gameData.renderTextureRed);
		Utils::BlitSprite(friendshipPicture, sf::Vector2f{ friendshipPicture.getPosition().x - (TROAD_GAP * (-1 * friendshipPicture.getPosition().y + WORKING_HEIGHT) / 100.f),friendshipPicture.getPosition().y }, 0, _gameData.renderTextureBlue);
	}
	else if (typeSelected[(int)TypeSelected::THIRD_DIMENTION])
	{
		Utils::BlitSprite(d3Picture, sf::Vector2f{ d3Picture.getPosition().x + (TROAD_GAP * (-1 * d3Picture.getPosition().y + WORKING_HEIGHT) / 100.f),d3Picture.getPosition().y }, 0, _gameData.renderTextureRed);
		Utils::BlitSprite(d3Picture, sf::Vector2f{ d3Picture.getPosition().x - (TROAD_GAP * (-1 * d3Picture.getPosition().y + WORKING_HEIGHT) / 100.f),d3Picture.getPosition().y }, 0, _gameData.renderTextureBlue);
	}
	else if (typeSelected[(int)TypeSelected::TUTO])
	{
		Utils::BlitSprite(tutoPicture, sf::Vector2f{ tutoPicture.getPosition().x + (TROAD_GAP * (-1 * tutoPicture.getPosition().y + WORKING_HEIGHT) / 100.f),tutoPicture.getPosition().y }, 0, _gameData.renderTextureRed);
		Utils::BlitSprite(tutoPicture, sf::Vector2f{ tutoPicture.getPosition().x - (TROAD_GAP * (-1 * tutoPicture.getPosition().y + WORKING_HEIGHT) / 100.f),tutoPicture.getPosition().y }, 0, _gameData.renderTextureBlue);
	}
...
void Settings::MovingUp(GameData& _gameData)
{
	if (!typeSelected[(int)TypeSelected::VOLUME])
	{
		...
		case TypeSelected::QUIT:
			if (lastPosIsLeft)
			{
				ChangeButtonSelected(_gameData, TypeSelected::QUIT, TypeSelected::RESET, true, true, SettingsButton::RESET, hpBarName, hpBarName, hpBarSelected, hpBarUnSelected);
			}
			else
			{
...
void Settings::MovingDown(GameData& _gameData)
{
	if (!typeSelected[(int)TypeSelected::QUIT])
	{
		...
		case TypeSelected::TUTO:
			...
			break;
		case TypeSelected::RESET:
			ChangeButtonSelected(_gameData, TypeSelected::RESET, TypeSelected::QUIT, true, true, SettingsButton::QUIT, hpBarName, hpBarName, hpBarSelected, hpBarUnSelected);
			break;
		case TypeSelected::APPLY:
...
void Settings::JoystickXBOXController(GameData& _gameData)
{
	if (sf::Joystick::getIdentification(0).name == "Wireless Controller")
	{
		...
		{
			if (buttonVect[(int)SettingsButton::RESET]->GetIsSelected() || buttonVect[(int)SettingsButton::APPLY]->GetIsSelected() || buttonVect[(int)SettingsButton::QUIT]->GetIsSelected())
			{
				SetButtonSelectedPressed(_gameData);
	...
	else
	{
		...
		if (sf::Joystick::isButtonPressed(0, (unsigned int)ControllerButtonXBOX::A) && (buttonSelected == (int)SettingsButton::QUIT || buttonSelected == (int)SettingsButton::APPLY || buttonSelected == (int)SettingsButton::RESET))
		{
			if (buttonVect[(int)SettingsButton::RESET]->GetIsSelected() || buttonVect[(int)SettingsButton::APPLY]->GetIsSelected() || buttonVect[(int)SettingsButton::QUIT]->GetIsSelected())
			{
				SetButtonSelectedPressed(_gameData);
